...
import { useBusinessStore } from '@/app/dashboard/details_new/stores/BusinessStore';

// Import simplified components
import BusinessSelector from '@/app/dashboard/details_new/components/BusinessSelector';
import BusinessInfo from '@/app/dashboard/details_new/components/BusinessInfo';
import CustomerSettings from '@/app/dashboard/details_new/components/CustomerSettings';
import FileManager from '@/app/dashboard/details_new/components/FileManager';
