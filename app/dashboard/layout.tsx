...
import { EnhancedServiceProvider } from '@/components/providers/service-provider'
...
const DashboardLayout: FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    // REMOVED: SupabaseProvider and AuthProvider - they already exist in root layout
    // REMOVED: ServiceProvider - EnhancedServiceProvider includes all functionality
    // This prevents duplicate provider instances and memory leaks
